document.addEventListener('DOMContentLoaded', () => {
    const allQuestions = {
        'December 2024': {
            "SPORTS 🏅": [
            {
                "q": "Rishabh Pant made history as the most expensive player in IPL auction history during the 2025 mega auction held in Jeddah, Saudi Arabia. The Indian wicketkeeper-batter was signed by which team for an astonishing 27 crore?",
                "a": "Lucknow Super Giants"
            },
            {
                "q": "Bihar youngster Vaibhav Suryavanshi has become the youngest player to earn an IPL deal, worth INR 1.10 crore (US$0.13 million approx.), from which IPL Team?",
                "a": "Rajasthan Royals"
            },
            {
                "q": "Who has become the fastest Indian batsman to score a century in T-20 format?",
                "a": "Urvil Patel"
            },
            {
                "q": "Where is the Under-19 Asia Cup Cricket Tournament - 2024 being held?",
                "a": "United Arab Emirates"
            },
            {
                "q": "Who won the men's singles title in Syed Modi International Badminton Championship?",
                "a": "Lakshya Sen"
            },
            {
                "q": "Who has won the Blind T20 World Cup title?",
                "a": "Pakistan"
            },
            {
                "q": "Who won the title of Men's Hockey Junior Asia Cup 2024?",
                "a": "India"
            },
            {
                "q": "Which country will host the inaugural Women's T20 World Cup for the Blind in 2025?",
                "a": "India"
            },
            {
                "q": "Which medal did PV Sindhu win in Syed Modi International Badminton Tournament?",
                "a": "Gold"
            },
            {
                "q": "Who has become the youngest chess world championship?",
                "a": "D Gukesh"
            },
            {
                "q": "Who has become the youngest player to take 100 wickets in all forms of cricket?",
                "a": "Shaheen Shah Afridi"
            },
            {
                "q": "Where will the Football World Cup not be held in 2030?",
                "a": "Saudi Arab"
            },
            {
            ...
            {
                "q": "Which country will host the FIFA Women's World Cup 2027?",
                "a": "Brazil"
            },
            {
                "q": "Which female cricketer has set the record for scoring the most centuries in a calendar year?",
                "a": "Smriti Mandhana"
            },
            {
                "q": "Who has won the 2024 Women's Hockey Junior Asia Cup title?",
                "a": "India"
            },
            {
                "q": "Who has won the 2024-2025 Syed Mushtaq Ali Trophy?",
                "a": "Mumbai"
            },
            {
                "q": "Which team won the 11th ACC U19 Men's Asia Cup by defeating India in the final?",
                "a": "Bangladesh"
            },
            {
                "q": "Who recently Retired from international cricket?",
                "a": "R Ashwin"
            },
            {
                "q": "Which country get hosting rights for the 2026 Asian Rifle and Pistol Cup?",
                "a": "India"
            },
            {
                "q": "Which of the following is the mascot of the 38th National Games?",
                "a": "Mauli"
            },
            {
                "q": "Which state become India's first to enact the sports Act 2024?",
                "a": "Punjab"
            },
            {
                "q": "Which country will host the 12th World Para Athletics Championships in 2025?",
                "a": "India"
            },
            {
                "q": "What is the position of Indian men's hockey team in the released FIH rankings?",
                "a": "5th"
            },
            {
                "q": "Who has been named by ICC to host the ICC Women's T20 WC 2028?",
                "a": "Pakistan"
            },
            {
                "q": "Indian women's team has scored its highest score of 217 in cricket history against which team?",
                "a": "West Indies"
            },
            {
                "q": "Who won the first edition of the U-19 Women's T20 Asia Cup?",
                "a": "India"
            },
            {
                "q": "Indian women's hockey team in the FIH World Rankings for December 2024?",
                "a": "9th"
            },
            {
                "q": "Women's Kabaddi World Cup 2025 will be held in which state of India?",
                "a": "Bihar"
            },
            {
                "q": "Who has become the first Indian woman cricketer to take six wickets twice in ODI?",
                "a": "Deepti Sharma"
            },
            {
                "q": "Who has won the title of Pro Kabaddi League Season - 11?",
                "a": "Haryana Steelers"
            },
            {
                "q": "Who is the youngest woman in the world to climb the seven highest peaks of the seven continents of the earth?",
                "a": "Kamya Karthikeyan"
            },
            {
                "q": "Who has become the fastest Indian bowler to take 200 Test wickets?",
                "a": "Jasprit Bumrah"
            },
            {
            ...
            "AWARDS & HONOURS 🏆": [
                {
                    "q": "Who has been honoured as the Indian Film Personality of the Year at the 55th International Film Festival of India (IFFI) 2024?",
                    "a": "Vikrant Massey"
                },
                {
                    "q": "The film titled \"Toxic\" won the Golden Peacock Award for Best Film at the 55th International Film Festival of India (IFFI) 2024. Which country is this film from?",
                    "a": "Lithuania"
                },
                {
                    "q": "Which series has been given the Best Series: Award in which series category at the Filmfare OTT Awards 2024?",
                    "a": "The Railway Men"
                },
                {
                    "q": "Who has Oxford chosen as the Word of the year 2024?",
                    "a": "Brain Rot"
                },
                {
                    "q": "Who has been selected for the Indira Gandhi Peace Prize 2024?",
                    "a": "Michelle Bachelet"
                },
                {
                ...
                {
                    "q": "Who has become the first Indian to be nominated for Best Director at the Golden Globe Awards 2025?",
                    "a": "Payal Kapadia"
                },
                {
                    "q": "Which Indian state's Abhathasahayeshwar Temple Conservation Project has won the 'Award of Distinction' of the 2024 UNESCO Asia-Pacific Prize for Cultural Heritage Conservation?",
                    "a": "Tamil Nadu"
                },
                {
                    "q": "Who was named 2024 WTA Player of the Year?",
                    "a": "Aryna Sabalenka"
                },
                {
                    "q": "Who has been honored as the Rising Star in Banking 2024?",
                    "a": "Bharti Kolli"
                },
                {
                    "q": "Who has been awarded UNEP's Earth Champion Award?",
                    "a": "Madhav Gadgil"
                },
                {
                    "q": "Who has been honored with the 34th Vyas Samman?",
                    "a": "Suryabala"
                },
                {
                    "q": "Who has been recently chosen as the Person of the Year by TIME magazine?",
                    "a": "Donald Trump"
                },
                {
                    "q": "In the National Panchayat Awards 2024, which state's Gram Panchayat Manyachiwadi has been awarded the Best Gram Panchayat Award in the Nanaji Deshmukh Best Panchayat Sustainable Development Award category?",
                    "a": "Maharashtra"
                },
                {
                    "q": "Which Indian film has won the Global Sustainability Film Award?",
                    "a": "The Kumbaya Story"
                },
                {
                    "q": "President Draupadi Murmu has conferred honorary general rank to the Army chief of which country?",
                    "a": "Nepal"
                },
                {
                    "q": "Which film was selected as the best film at the 30th Kolkata International Film Festival (KIFF)?",
                    "a": "Stadoto"
                },
                {
                ...
                {
                    "q": "Which Indian educationist has been honoured with royal honour by Bhutan?",
                    "a": "Arun Kapoor"
                },
                {
                ...
                {
                    "q": "Melbourne Cricket Club (MCC) announced to honor which former Indian cricketer with club membership?",
                    "a": "Sachin Tendulkar"
                },
                {
                ...
                {
                    "q": "Who has topped the list of \"India's Top 200 Self-made Entrepreneurs of the Millenia 2024\"?",
                    "a": "R S Damani"
                },
                {
                    "q": "Who among the following has won the BBC Sports Personality of the Year 2024 award?",
                    "a": "Keely Hodgkinson"
                },
                {
            ...
            "BOOKS & AUTHORS 📚": [
                {
                    "q": "Who has written the book 'Bring It On: The Incredible Story of My Life'?",
                    "a": "Deepa Malik"
                },
                {
                    "q": "Which Nobel Laureate of India has authored the book 'Chhaunk-On Food, Economics and Society'?",
                    "a": "Abhijit Banerjee"
                },
                {
                    "q": "Former Prime Minister of India Dr. Manmohan Singh Ji passed away in December 2024, what is the name of Dr. Manmohan Singh's autobiography?",
                    "a": "Changing India"
                },
                {
                    "q": "The book 'Stumped' is the autobiography of which Indian cricketer?",
                    "a": "Syed Kirmani"
                }
            ],
            "APPOINTMENTS & RESIGNATIONS 💼": [
                {
                    "q": "Recently 'Udhayanidhi Stalin' became Deputy Chief Minister of Which state?",
                    "a": "Tamil Nadu"
                },
                {
                ...
                {
                    "q": "Who has been appointed Director-General of the World Trade Organization (WTO) for the second time in November 2024?",
                ...
                {
                    "q": "Who has become the second woman Chief Justice of Sri Lanka?",
                    "a": "Murdu Fernando"
                },
                {
                ...
                {
                    "q": "Who has been appointed as the Chairman of the Indian Council of Historical Research in December 2024?",
                    "a": "Raghuvendra Tanwar"
                },
                {
                    "q": "Who has become the new President of ACC?",
                    "a": "Shammi Silva"
                },
                {
                    "q": "Who has Eurogrip Tyres made its brand ambassador?",
                    "a": "M.S. Dhoni"
                },
                {
                ...
                {
                    "q": "Who has become the interim prime minister in Syria?",
                    "a": "Mohammad al-Bashir"
                },
                {
                    "q": "'Emmanuel Ouédraogo' has been appointed as the new Prime Minister of which country?",
                    "a": "Burkina Faso"
                },
                {
                    "q": "Who has been appointed as the Revenue Secretary by the Government of India in December 2024?",
                    "a": "Ajay Seth"
                },
                {
                    "q": "Who will become the new Prime Minister of France?",
                    "a": "Francois Bayrou"
                },
                {
                    "q": "Who has become the brand ambassador of 'Cash free Payments'?",
                    "a": "Rajkumar Rao"
                },
                {
                    "q": "Who has become India's Doubles Badminton Coach?",
                    "a": "Tan Kim Her"
                },
                {
                    "q": "The President of South Korea was removed from office, what is his name?",
                    "a": "Yoon Suk Yeol"
                },
                {
                    "q": "Which Indian cricketer has been appointed as the brand ambassador of Techjockey?",
                    "a": "Rishabh Pant"
                },
                {
                    "q": "Who become 1st Indian to elected as the Secretary General of the Fencing Confederation of Asia (FCA)?",
                    "a": "Rajeev Mehta"
                },
                {
                    "q": "Who became the President of Georgia?",
                    "a": "Mikhail Kavelashvili"
                },
                {
                    "q": "Who has been appointed as the new country manager of Google India?",
                    "a": "Preeti Lobana"
                },
                {
                    "q": "Who has become the brand ambassador of Kho Kho World Cup?",
                    "a": "Salman Khan"
                },
                {
                    "q": "Who has become the President of UN Internal Justice Council?",
                    "a": "Madan Lokur"
                },
                {
                    "q": "Who has been appointed as MD of SBI?",
                    "a": "Ram Mohan Rao Amara"
                },
                {
                    "q": "Who has become the new MD/CEO of Jammu Kashmir Bank?",
                    "a": "Amitav Chatterjee"
                },
                {
                    "q": "Recently 'Aisake Valu Eke' became the new Prime Minister of which country?",
                    "a": "Tonga"
                },
                {
                    "q": "'Maia Sandu' Sworn in as President of which country?",
                    "a": "Moldova"
                },
                {
                    "q": "Who has been appointed the new Secretary of the 'Revenue Department' ?",
                    "a": "Arunish Chawla"
                },
                {
                    "q": "General (Dr.) Vijay Kumar Singh (Retd.) has been appointed as Governor of which state in December 2024?",
                    "a": "Mizoram"
                },
                {
                    "q": "Who has been appointed as the Chairman of the National Accreditation Board for Testing and Calibration Laboratories (NABL) in December 2024?",
                    "a": "Dr. Sandip Shah"
                },
                {
                    "q": "Who has been appointed as the Secretary of the Minorities Commission?",
                    "a": "Sanjay Sethi"
                },
                {
                    "q": "Who has become the new DG of CRPF?",
                    "a": "Vitul Kumar"
                },
                {
                    "q": "Who became the Chairman of National Human Rights Commission?",
                    "a": "V Ramasubrahmanyan"
                },
                {
                    "q": "Who became the new Prime Minister of Iceland?",
                    "a": "Kristrun Frostadóttir"
                },
                {
                    "q": "Who has been appointed as the Chairman of the Economic Advisory Council to the Prime Minister (EAC-PM)?",
                    "a": "Suman Berry"
                },
                {
                    "q": "Who has become the new Governor of Bihar?",
                    "a": "Arif Mohammad Khan"
                },
                {
                    "q": "Recently who become the new governor of 'Odisha'?",
                    "a": "Hari Babu Kambhampati"
                },
                {
                    "q": "Who has been appointed as the Senior White House Policy Advisor on Artificial Intelligence by President-elect Donald Trump?",
                    "a": "Sriram Krishnan"
                }
            ],
            "NATIONAL AFFAIRS 🇮🇳": [
                ...
                {
                    "q": "Vadhavan greenfield port has been developed in which state?",
                    "a": "Maharashtra"
                },
                {
                ...
                {
                    "q": "Minister for Environment, Forest and Climate Change, Bhupender Yadav released the 'India State of Forest Report 2023 (ISFR 2023) at Forest Research Institute, Dehradun. When was the first India State of Forest Report (ISFR) published?",
                    "a": "1987"
                },
                {
                    "q": "Which former Prime Minister's 100th birth anniversary was commemorated during the foundation stone laying ceremony of Ken-Betwa River Linking Project?",
                ...
                {
                    "q": "Which of the following is the theme for the tableaux to be showcased at the Republic Day Parade 2025?",
                    "a": "Swarnim Bharat: Virasat aur Vikas"
                },
                {
                    "q": "The Ministry of Civil Aviation has launched the \"Udaan Yatri Cafe\" at which airport?",
                    "a": "Kolkata Airport"
                }
            ],
            "INTERNATIONAL AFFAIRS 🌍": [
                {
                    "q": "Which country is set to re-launch the Free Trade Agreement (FTA) negotiations with India in early 2025?",
                    "a": "United Kingdom"
                },
                {
                    "q": "Which country has recently declared a \"National Disaster\" due to food poisonings?",
                    "a": "South Africa"
                },
                {
                    "q": "Who has been re-elected to the United Nations Peace building Commission?",
                    "a": "India"
                },
                {
                    "q": "Which country is hosting the 16th United Nations Conference on Desertification (UNCCD COP16)?",
                    "a": "Saudi Arabia"
                },
                {
                    "q": "In which country martial law was imposed by the President and was removed within a few hours?",
                    "a": "South Korea"
                },
                {
                    "q": "Which country was the partner country in the 2024 international Gita Mahotsav?",
                    "a": "Tanzania"
                },
                {
                    "q": "Who was the President of Syria for the past 24 years, who fled the country after the rebel forces took control in December 2024?",
                    "a": "Bashar al-Assad"
                },
                {
                    "q": "To which country has India sent 2,200 metric tons of rice in December 2024?",
                    "a": "Myanmar"
                },
                {
                    "q": "Which country has unveiled the world's largest gold brick in December 2024?",
                    "a": "Dubai (UAE)"
                },
                {
                    "q": "Who has become World's 1st Country to release a National Soundscape?",
                    "a": "Finland"
                },
                {
                    "q": "Paulo Rangel, who visited India, is the Foreign Minister of which country?",
                    "a": "Portugal"
                },
                {
                    "q": "Who refused to accept 'Joy Bangla' as the national slogan?",
                    "a": "Bangladesh"
                },
                {
                    "q": "Which country has become the 105th Country of ISA?",
                    "a": "Moldova"
                },
                {
                    "q": "Where was the 24th BIMSTEC meeting held meeting recently?",
                    "a": "Thailand"
                },
                {
                    "q": "India has established “AYUSH CHAIRS” at how many countries?",
                    "a": "5 Countries"
                },
                {
                    "q": "Which bird has been declared as America's 'official national bird'?",
                    "a": "Bald Eagle"
                },
                {
                    "q": "Which country will build the world's largest hydropower dam?",
                    "a": "China"
                },
                {
                    "q": "Which country will host WAVES (World Audio Visual Entertainment Summit) in 2025?",
                    "a": "India"
                },
                {
                    "q": "Which country will chair the 68th session of the Narcotics Drugs Commission?",
                    "a": "India"
                },
                {
                    "q": "What is the position of India in the Eurasian Times list of 'The Great Powers of 2025'?",
                    "a": "Fifth"
                }
            ],
            "SCIENCE & TECHNOLOGY 🔬": [
                ...
                {
                    "q": "India's first indigenous anti-insecticide bodysuit launched, its name?",
                    "a": "Kisan Kavach"
                },
                {
                    "q": "Which country plans to launch a free mRNA cancer vaccine in 2025?",
                    "a": "Russia"
                },
                {
                    "q": "What is the name of India's 1st low-floor electric city bus?",
                    "a": "SWITCH EiV12"
                },
                {
                    "q": "Where will India's largest Al city be built on 200 acres recently?",
                    "a": "Hyderabad"
                },
                {
                ...
                },
                {
                    ...
                    "a": "ISRO and European Space Agency (ESA)"
                }
            ],
            "DEFENCE & MILITARY 🛡️": [
                {
                    "q": "With which country has India signed an agreement to design electric propulsion systems for the Navy?",
                    "a": "Britian"
                },
                {
                    "q": "The first edition of military exercise CINBAX 2024 is being held between which two countries?",
                    "a": "India and Cambodia"
                },
                {
                    "q": "Harimau Shakti military exercise took place between India and which country in Dec 2024?",
                    "a": "Malaysia"
                },
                {
                    "q": "Where has Indian Army successfully installed Optical Fibre connectivity for the first time?",
                    "a": "Siachen"
                },
                {
                    "q": "Joint military exercise AGNI WARRIOR (XAW-2024), a bilateral exercise between the Indian Army and the Singapore Armed Forces, concluded at Field Firing Range, Devlali (Maharashtra) on which edition?",
                    "a": "13th"
                },
                {
                    "q": "In SIPRI 'Top 100 Arms - Producing & Military Services Companies in the world report 2023, India's largest company HAL is at which number.",
                    "a": "43"
                },
                {
                    "q": "Which country will set up a comprehensive anti-drone unit to deal with drone-related threats?",
                    "a": "India"
                },
                {
                    "q": "Which two countries including India participated in the recently held exercise Desert Knight?",
                    "a": "France and United Arab Emirates (UAE)"
                },
                {
                    "q": "In December 2024, the joint military exercise Sahyog HOP TAC-2024 was held between India and which country?",
                    "a": "Vietnam"
                },
                {
                    "q": "Surya Kiran military exercise was organized between India and which country?",
                    "a": "Nepal"
                },
                {
                    "q": "Army Day Parade 2025 will be held in which city?",
                    "a": "Pune"
                }
            ],
            "ECONOMY & BUSINESS 💰": [
                ...
                {
                    "q": "Which tax has been withdrawn by the Government of India on Aviation Turbine Fuel, Crude Oil, Petrol and Diesel?",
                    "a": "Windfall"
                },
                {
                    "q": "Uber has launched its first water transport service in which lake of India?",
                    "a": "Dal Lake, Jammu Kashmir"
                },
                {
                    "q": "How much has RBI increased the limit of UPI light wallet?",
                    "a": "Rs. 5000"
                },
                {
                ...
                {
                    "q": "As per the UBS report, India's billionaire count has reached to",
                    "a": "185"
                },
                {
                ...
                {
                    "q": "In which city Google has announced to set up India's first Google Safety Engineering Center?",
                    "a": "Hyderabad"
                },
                {
            ...
            "IMPORTANT DAYS & THEMES 🗓️": [
                {
                    "q": "'World AIDS Day' 2024 is celebrated on which date?",
                    "a": "01 December"
                },
                {
                    "q": "What was the theme of the 43rd India International Trade Fair 2024?",
                    "a": "Viksit Bharat at 2047"
                },
                {
                    "q": "\"World Computer Literacy Day\" is observed every year on",
                    "a": "2nd December"
                },
                {
                    "q": "\"International Day for the Abolition of Slavery\" is observed annually on -",
                    "a": "2nd December"
                },
                {
                    "q": "\"In India National Pollution Control Day\" is observed every year on -",
                    "a": "2nd December"
                },
                {
                    "q": "\"World Handicapped Day\" is observed every year on",
                    "a": "3rd December"
                },
                {
                    "q": "What is the theme of National Pollution Control Day-2024?",
                    "a": "\"Clean Air, Green Earth: A Step Towards Sustainable Living.\""
                },
                {
                    "q": "When 'National Navy Day' 2024 is celebrated?",
                    "a": "4th December"
                },
                {
                    "q": "\"Rajendra Prasad Jayanti\" is observed every year on -",
                    "a": "3rd December"
                },
                {
                    "q": "\"International day of Bank\" is observed every year on -",
                    "a": "4th December"
                },
                {
                    "q": "\"International Cheetah day\" is observed every year on",
                    "a": "4th December"
                },
                {
                    "q": "\"World Soil Day\" is observed every year on",
                    "a": "5th December"
                },
                {
                    "q": "\"International Volunteer Day\" is observed every year on",
                    "a": "5th December"
                },
                {
                    "q": "What is the theme of Indian Navy Day 2024?",
                    "a": "Strength and Power through Innovation and Indigenization"
                },
                {
                    "q": "\"Mahaparinivan Divas\" is observed every year on",
                    "a": "6th December"
                },
                {
                    "q": "\"International Civil Aviation Day\" is marked every year on",
                    "a": "7th December"
                },
                {
                    "q": "\"The Armed Forces Flag Day\" is observed every year on",
                    "a": "7th December"
                },
                {
                    "q": "When will World Wildlife Conservation Day be celebrated?",
                    "a": "4th December"
                },
                {
                    "q": "When was International Anti-Corruption Day celebrated?",
                    "a": "9 December"
                },
                {
                    "q": "When 'World Human Rights Day' is celebrated?",
                    "a": "10 December"
                },
                {
                    "q": "When 'International Day of Commemoration and Dignity of the Victims of the Crime of Genocide' 2024 is observed?",
                    "a": "09 December"
                },
                {
                    "q": "When was International Mountain Day celebrated?",
                    "a": "11 December"
                },
                {
                    "q": "When 'UNICEF Day' 2024 is celebrated?",
                    "a": "11 December"
                },
                {
                    "q": "When was Universal Health Coverage Day celebrated?",
                    "a": "12 December"
                },
                {
                ...
                {
                    "q": "When is 'International Day of Neutrality' celebrated in 2024?",
                    "a": "12 December"
                },
                {
                    "q": "'Vijay Diwas 2024' is celebrated on which date?",
                    "a": "16 December"
                },
                {
                    "q": "\"International Migrants Day\" is observed every year on",
                    "a": "18th December"
                },
                {
                    "q": "\"National Minorities Rights Day\" is observed every year on",
                    "a": "18th December"
                },
                {
                    "q": "When was the first World Meditation Day celebrated?",
                    "a": "21 December"
                },
                {
                    "q": "When was International Human Solidarity Day Celebrated?",
                    "a": "20 December"
                },
                {
                    "q": "When was National mathematics Day celebrated?",
                    "a": "22 December"
                },
                {
                    "q": "The first World Meditation Day was observed on 21 December, what is the theme of World Meditation Day - 2024?",
                    "a": "\"Meditation for Global Peace and Harmony\""
                },
                {
                    "q": "“Kishan Diwas’’ is observed every year on –",
                    "a": "23rd December"
                },
                {
                    "q": "On which date 'International Day of Epidemic Preparedness 2024' is celebrated?",
                    "a": "27 December"
                },
                {
                    "q": "Whose bravery and sacrifice is honored on Veer Baal Diwas annually on December 26?",
                    "a": "Guru Gobind Singh Ji's younger sons"
                },
                {
                    "q": "When will World Meditation Day be celebrated?",
                    "a": "21th December"
                },
                {
                    "q": "“SAARC Charter Day ’’ is observed every year on –",
                    "a": "8th December"
                },
                {
                    "q": "“National Consumer Right Day’’ is marked every year on –",
                    "a": "24th December"
                },
                {
                    "q": "On which date 'Good Governance Day' 2024 is celebrated?",
                    "a": "25 December"
                }
            ],
            "OBITUARIES 🕊️": [
            ...
            "MISCELLANEOUS 💡": [
                {
                    "q": "Which organization developed The Teacher App, launched by Shri Dharmendra Pradhan?",
                    "a": "Bharti Airtel"
                },
                {
                ...
                {
                    "q": "How many Indians have been included in the Forbes list of the world's most powerful women?",
                    "a": "3"
                },
                {
        ...
        'January 2025': {
            "SPORTS 🏅": [
                {
                    "q": "Which team has won its 33rd 'Santosh Trophy' in the 78th edition of Santosh Trophy 2024-25?",
                    "a": "West Bengal"
                },
                {
                ...
                {
                    "q": "Who has become the first Indian woman player to score the fastest 4,000 runs in ODIs?",
                    "a": "Smriti Mandhana"
                },
                {
                    "q": "Where is India's first Women's Hockey India League being organized?",
                    "a": "Jharkhand"
                },
                {
                ...
                {
                    "q": "Which Indian woman cricketer recently set the record for the fastest century in ODIs?",
                    "a": "Smriti Mandhana"
                },
                {
                ...
                {
                    "q": "The 2nd ICC U-19 Women's T20 World Cup 2025 is being organised by the International Cricket Council (ICC) in which country?",
                    "a": "Malaysia"
                },
                {
                    "q": "Who has won Vijay Hazare Trophy 2024 – 25?",
                    "a": "Karnataka"
                },
                {
                    "q": "Who won the title of Kho-Kho World Cup 2025?",
                    "a": "India"
                },
                {
            ...
            "AWARDS & HONOURS 🏆": [
                ...
                {
                    "q": "Who won the Golden Globe Award for Best Motion Picture (Non-English Language) at the recently held 82nd Golden Globe Awards 2025?",
                    "a": "Emilia Perez"
                },
                {
            ...
            "APPOINTMENTS & RESIGNATIONS 💼": [
                ...
                {
                    "q": "Who has been appointed as the Chairman and Managing Director (CMD) of Food Corporation of India (FCI)?",
                ...
                {
                    "q": "Who has been appointed as the Chairman of the reconstituted Atomic Energy Commission (AEC)?",
                    "a": "Ajit Kumar Mohanty"
                },
                {
                    "q": "Who has been appointed as Lebanon's new Prime Minister?",
                    "a": "Nawaf Salam"
                },
                {
                    "q": "Who has been recently appointed as the Special Director General of the Central Reserve Police Force (CRPF)?",
                    "a": "Sunil Kumar Jha"
                },
                {
                    "q": "Who has been elected as the chairman of PM Museum and Library Committee?",
                    "a": "Nripendra Mishra"
                },
                {
                    "q": "Who has been recently appointed as the new batting coach of the Indian cricket team?",
                    "a": "Sitanshu Kotak"
                },
                {
            ...
            "NATIONAL AFFAIRS 🇮🇳": [
                ...
                {
                    "q": "By what percentage has e-waste generation increased in India over the past five years?",
                    "a": "72.54%"
                },
                {
                ...
                {
                    "q": "In December 2024, Indian Railways has completed the trial run on India's first cable-stayed rail bridge 'Anji Khad Bridge' in which state/UT?",
                    "a": "Jammu Kashmir"
                },
                {
                    "q": "Which dam is being constructed under the Ken-Betwa lin national project?",
                    "a": "Daudhan dam"
                },
                {
                ...
                {
                    "q": "Which Union Minister has launched 'Sashakt Beti' and 'E-Drishti Projects'?",
                ...
                {
                    "q": "The Union Government has approved the construction of a memorial of which former President of India in the Rajghat complex?",
                    "a": "Pranab Mukherjee"
                },
                {
                    "q": "Which became the second state to launch 'Bima Sakhi Yojana'?",
                    "a": "Goa"
                },
                {
                ...
                {
                    "q": "Which metro has unveiled 'India's first indigenously built driverless metro train'?",
                    "a": "Bengaluru Metro Rail"
                },
                {
                    "q": "Who launched a special song 'Mahakumbh Hai' dedicated to Maha Kumbh 2025?",
                    "a": "Ashwini Vaishnav"
                },
                {
                    "q": "By what name did the Chief Minister of Uttar Pradesh launch an FM channel for Maha Kumbh 2025?",
                    "a": "Kumbhvani"
                },
                {
                ...
                {
                    "q": "Which state government announced to give monthly pension to those who went to jail during the Emergency?",
                    "a": "Odisha"
                },
                {
                ...
                {
                    "q": "Which ministry has created Kalagram to showcase India's vibrant culture during the Mahakumbh in Prayagraj?",
                ...
                {
                    "q": "Who become 1st state in Northeast India to distribute property cards under the SVAMITVA scheme?",
                    "a": "Mizoram"
                },
                {
                    "q": "By which year did the Government of India set a target of 10,000 GI tags?",
                    "a": "2030"
                },
                {
            ...
            "INTERNATIONAL AFFAIRS 🌍": [
                ...
                {
                    "q": "Which country has implemented tourist tax from 1 Jan 2025?",
                    "a": "Russia"
                },
                {
                    "q": "In which country has the Human Metapneumovirus spread?",
                    "a": "China"
                },
                {
                    "q": "Which neighboring country of India has joined the UNSC as atemporary member in Jan 2025?",
                    "a": "Pakistan"
                },
                {
                ...
                {
                    "q": "According to the Hanley Passport Index, which country's passport is said to be the most powerful?",
                    "a": "Singapore"
                },
                {
                ...
                {
                    "q": "Zoran Milanovic was re-elected as the President of which country?",
                    "a": "Croatia"
                },
                {
                    "q": "Which country will host the 28th Conference of Speakers and Presiding Officers of Parliament (CSPOC) in 2026?",
                    "a": "India"
                },
                {
                ...
                {
                    "q": "Who will represent India in the swearing-in ceremony of 'Donald Trump' on 20 January 2025?",
                    "a": "Dr. S. Jaishankar"
                },
                {
                    "q": "India and which country have declared 2026 as a double year?",
                    "a": "Spain"
                },
                {
            ...
            "SCIENCE & TECHNOLOGY 🔬": [
                ...
                {
                    "q": "Which Indian organization partnered with Microsoft to drive Al adoption and development in India?",
                    "a": "IndiaAl"
                },
                {
                ...
                {
                    "q": "Which country has built the world's most powerful hydrogen train engine?",
                    "a": "India"
                },
                {
                    "q": "Which country successfully performed the world's first Cardiac Telesurgery using a robotic system?",
            ...
            "DEFENCE & MILITARY 🛡️": [
                ...
                {
                    "q": "Which foundation day of DRDO was celebrated on 1 January 2025?",
                    "a": "67th"
                },
                {
                    "q": "Which ministry has declared 2025 as the year of reforms?",
                    "a": "Ministry of Defence"
                },
                {
                    "q": "The 6th and last P-75 Scorpion submarine joined the Indian Navy, what is its name?",
                    "a": "Vaghsheer"
                },
                {
            ...
            "ECONOMY & BUSINESS 💰": [
                ...
                {
                    "q": "The e-Shram portal, which has been in the news recently, is related to which sector?",
            ...
            "IMPORTANT DAYS & THEMES 🗓️": [
                {
                    "q": "When was Global Family Day celebrated?",
                    "a": "1 Jan"
                },
                {
                    "q": "January 4 is observed as which day?",
                    "a": "World Braille Day"
                },
                {
                    "q": "On which date 'Savitribai Phule Jayanti' 2025 is celebrated?",
                    "a": "03 January"
                },
                {
                    "q": "On which date will the first Lokpal Day be celebrated in 2025?",
                    "a": "January 16"
                },
                {
                ...
                {
                    "q": "When the death anniversary of former Prime Minister of India 'Lal Bahadur Shastri' is celebrated?",
                    "a": "11 January"
                },
                {
                    "q": "On which date 'National Human Trafficking Awareness Day' 2025 is celebrated?",
                    "a": "11 January"
                },
                {
                ...
                {
                    "q": "National Disaster Response Force (NDRF) Day is observed every year on –",
                    "a": "19th January"
                },
                {
                    "q": "When is Parakram Diwas celebrated every year?",
                    "a": "23rd January"
                },
                {
                    "q": "When was National Girl Child Day celebrated?",
                    "a": "24 January"
                },
                {
                ...
                {
                    "q": "International Customs Day 2025 is observed every year on -",
                    "a": "26th January"
                },
                {
    ...
    },
    {
      ...
      "a": "India"
            ...
            "APPOINTMENTS & RESIGNATIONS 💼": [
                ...
                {
                "q": "To whom the government assigned the additional charge of the Revenue Secretary to Department of Economic Affairs (DEA)?",
                "a": "Ajay Seth"
                },
                {
                ...
                {
                "q": "Who has been appointed as the first woman law secretary?",
                "a": "Anju Rathi Rana"
                },
                {
                "q": "Who has been appointed as new Executive Director of RBI?",
                ...
                {
                "q": "Who has been appointed as the new brand ambassador of Sony India for its audio products category?",
                "a": "Karan Aujla"
                },
                {
            ...
            "NATIONAL AFFAIRS 🇮🇳": [
                ...
                {
                "q": "Recently which country achieved the target of a maternal mortality rate of 100 deaths per one lakh live births?",
                "a": "India"
                },
                {
                "q": "Recently India's first hydrogen truck trials have been begun by which company?",
                "a": "Tata Motors"
                },
                {
                ...
                {
                "q": "Which metro rail corporation has become the first to launch urban cargo Service?",
                "a": "Delhi"
                },
                {
                ...
                {
                "q": "Lachit Barphukan Police Academy was inaugurated by Union Home Minister Amit Shah. Where is this academy located?",
                "a": "Assam"
                },
                {
                ...
                {
                "q": "The 'Sansad Bhashini' initiative, aimed at developing Al-based in-house solutions, is jointly undertaken by which entities?",
                "a": "Lok Sabha Secretariat and Ministry of Electronics and Information Technology (MEITY)"
                },
                {
            ...
            "INTERNATIONAL AFFAIRS 🌍": [
                ...
                "a": "US, UK, Canada, Australia, and New Zealand"
                },
                {
                ...
                {
                "q": "Recently India actively took part in the 353rd Governing Body Meeting of the International Labour Organisation (ILO), it is held in which city?",
                "a": "Geneva"
                },
                {
            ...
            "IMPORTANT DAYS & THEMES 🗓️": [
                {
                "q": "On which date 'World Civil Defence Day' 2025 is celebrated?",
                "a": "01 March"
                },
                {
                "q": "On which date 'Zero Discrimination Day' 2025 is celebrated?",
                "a": "01 March"
                },
                {
                "q": "From when to when was Jan Aushadhi Week 2025 organized?",
                "a": "1-7 March"
                },
                {
                "q": "On which date 'National Safety Day' 2025 is celebrated?",
                "a": "04 March"
                },
                {
                ...
                {
                "q": "When was International Women Judges Day 2025 celebrated?",
                "a": "10 March"
                },
                {
                ...
                {
                "q": "'International Day of Action for Rivers' 2025 is celebrated on which date?",
                "a": "14 March"
                },
                {
                ...
                {
                "q": "When is National Vaccination Day 2025 observed every year?",
                "a": "16th March"
                },
                {
                "q": "When is the International Day of Happiness celebrated every year?",
                "a": "20th March"
                },
                {
                "q": "When was World Sparrow Day celebrated?",
                "a": "20 March"
                },
                {
                ...
                {
                "q": "On which date 'World Poetry Day' 2025 is celebrated?",
                "a": "21 March"
                },
                {
    ...
    // --- Helper Functions ---
    // Function to render a list of questions within the modal
    function renderQuestionListInModal(questions, title) {
        modalListContainer.innerHTML = ''; // Clear previous content

        const titleHeader = document.createElement('h2');
        titleHeader.textContent = title;
        modalListContainer.appendChild(titleHeader);

        // Group questions by category if provided
        for (const category in questions) {
            const categoryHeader = document.createElement('h3');
            categoryHeader.textContent = category;
            modalListContainer.appendChild(categoryHeader);

            questions[category].forEach(qa => {
                const questionItem = document.createElement('div');
                questionItem.className = 'question-item';
                questionItem.innerHTML = qa.q;

                const answerText = document.createElement('div');
                answerText.className = 'answer-text';
                answerText.innerHTML = `<strong>Answer:</strong> ${qa.a}`;
                ...
                modalListContainer.appendChild(questionItem);
                modalListContainer.appendChild(answerText);
            });
        }
    ...
    function filterQuestions(searchQuery, questions) {
        const filteredQuestions = {};
        const query = searchQuery.toLowerCase();

        for (const category in questions) {
            const filtered = questions[category].filter(qa =>
                qa.q.toLowerCase().includes(query) || qa.a.toLowerCase().includes(query)
            );
            if (filtered.length > 0) {
                filteredQuestions[category] = filtered;
            }
        }
    ...
    // --- Main Logic ---
    const monthContentContainer = document.getElementById('month-content-container');
    const categoryContentContainer = document.getElementById('category-content-container');
    const monthSearchInput = document.getElementById('month-search');
    const categorySearchInput = document.getElementById('category-search');

    if (monthContentContainer) {
        // Correctly iterate over all months in allQuestions
        for (const month in allQuestions) {
            // Ensure the month has data before creating a card
            if (Object.keys(allQuestions[month]).length > 0) {
                const card = document.createElement('div');
                card.className = 'card';
                card.innerHTML = `<h3>${month}</h3>`;
                card.addEventListener('click', () => {
                    renderQuestionListInModal(allQuestions[month], month);
                });
                monthContentContainer.appendChild(card);
            }
        }


        monthSearchInput.addEventListener('keydown', (e) => {
            if (e.key === 'Enter' && e.target.value.trim() !== '') {
                const allFiltered = {};
                 // Search through all months
                for (const month in allQuestions) {
                    const filtered = filterQuestions(e.target.value, allQuestions[month]);
                    if (Object.keys(filtered).length > 0) {
                       for(const cat in filtered){
                           if(!allFiltered[cat]){
                               allFiltered[cat] = [];
                           }
                           allFiltered[cat] = allFiltered[cat].concat(filtered[cat]);
                       }
                    }
                }

                if (Object.keys(allFiltered).length > 0) {
                    renderQuestionListInModal(allFiltered, `Search results for "${e.target.value}"`);
                } else {
                    alert('No questions found matching your search.');
                }
            }
        });
    }
    ...
    if (categoryContentContainer) {
        ...
        // Aggregate all unique categories from all months
        for (const month in allQuestions) {
            for (const category in allQuestions[month]) {
                if (!uniqueCategories[category]) {
                    uniqueCategories[category] = [];
                }
                uniqueCategories[category].push(...allQuestions[month][category]);
            }
        }
        ...
        for (const category in uniqueCategories) {
            ...
            card.addEventListener('click', () => {
                ...
                renderQuestionListInModal(questionsForCategory, category);
            });
            categoryContentContainer.appendChild(card);
        }
